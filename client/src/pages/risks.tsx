            ...
            <CardContent className="p-4">
              <div className="flex items-start gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="text-sm font-semibold mb-1" data-testid={`text-risk-title-${risk.risk_id}`}>{risk.title}</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">{risk.description}</p>
                  <div className="grid grid-cols-3 gap-3 mb-3">
                    ...
                    <div className="bg-muted/50 rounded-md p-2">
                      ...
                      {risk.exposure ? <SeverityBadge severity={risk.exposure} /> : <span className="text-xs text-muted-foreground">--</span>}
                    </div>
                  </div>
                  {risk.mitigation && (
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    ...
                    {risk.related_element_ids && <ElementRefList refs={risk.related_element_ids} label="Related" />}
                  </div>
                </div>
              </div>
            </CardContent>
